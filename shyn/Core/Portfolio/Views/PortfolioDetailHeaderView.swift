...
//  SwiftCoin
//
//  Created by Stephen Dowless on 1/23/22.
//
...
struct PortfolioDetailHeaderView: View {
    ...
    var body: some View {
        VStack {
            HStack {
                PortfolioHeaderDetailItem(title: "Gesamtwert Portfolio",
                ...
                PortfolioHeaderDetailItem(title: "Gesamtänderung",
            ...
            HStack {
                PortfolioHeaderDetailItem(title: "Available",
